...
- Controls response variability for the promptfile
- Use a decimal value such as `0.0`, `0.2`, or `0.7`
- Lower values are better for deterministic tasks like code review, refactoring guidance, and compliance checks
- Higher values are better for exploratory tasks like brainstorming or drafting alternatives
...
# - temperature: Optional (controls response variability)
name: generate-tests
...
- [ ] `temperature` is present when output consistency or creativity needs explicit control
